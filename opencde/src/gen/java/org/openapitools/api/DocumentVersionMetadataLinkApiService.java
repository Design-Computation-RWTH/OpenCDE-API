...
public abstract class DocumentVersionMetadataLinkApiService {
    public abstract Response getDocumentMetadata(SecurityContext securityContext) throws NotFoundException;
}
