...
public abstract class DocumentReferenceLinkApiService {
    public abstract Response getDocumentReference(SecurityContext securityContext) throws NotFoundException;
}
