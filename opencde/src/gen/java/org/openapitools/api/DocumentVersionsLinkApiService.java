...
public abstract class DocumentVersionsLinkApiService {
    public abstract Response getDocumentVersions(SecurityContext securityContext) throws NotFoundException;
}
