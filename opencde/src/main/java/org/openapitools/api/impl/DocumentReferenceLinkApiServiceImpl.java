...
public class DocumentReferenceLinkApiServiceImpl extends DocumentReferenceLinkApiService {
    @Override
    public Response getDocumentReference(SecurityContext securityContext) throws NotFoundException {
        // do some magic!
